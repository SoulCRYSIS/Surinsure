...
class CarPolicyForm extends StatefulWidget {
  const CarPolicyForm(
      {required this.customerId,
      required this.propertyId,
      this.editFrom,
  ...
  @override
  State<CarPolicyForm> createState() => _CarPolicyFormState();
}

class _CarPolicyFormState extends State<CarPolicyForm> {
  String policyNumber = '';
  DateTime? startDate;
  DateTime? endDate;
  ...
  void initState() {
    if (isEditing) {
      final CarPolicy e = widget.editFrom!.data as CarPolicy;
                    ...
                    UiUtil.confirmDialog(
                      ...
                      onConfirm: (closeDialog) async {
                        ...
                        if (ServerData.insuranceCompanies.contains(input)) {
                          ...
                          // ignore: use_build_context_synchronously
                          UiUtil.snackbar(context, 'เพิ่มสำเร็จ',
                              isError: false);
                        }
                        setState(() {});
                      },
